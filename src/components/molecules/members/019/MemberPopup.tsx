...
return createPortal(
  <>
    ...
    <div 
      className="fixed inset-0 flex flex-col items-center justify-center bg-slate-950 pointer-events-none overflow-hidden" 
    ...
    >
      ...
      <div className="absolute z-10 flex w-full h-full items-center justify-center" style={{ animation: 'logoFade 2.5s ease-in-out forwards' }}>
        {/* Kalau kamu taruh logo di folder public, cukup panggil "/mercedes-logo.png" */}
        {/* Kalau belum didownload, ganti valuenya dengan link URL internet sebelumnya */}
        <img 
          src="src/components/molecules/members/019/mercedes-logo.png" 
          alt="Mercedes Logo" 
    ...
    >
      ...
      <div className="relative z-10 my-auto w-full max-w-[720px] overflow-y-auto rounded-3xl border border-white/10 bg-slate-900/95 p-6 text-slate-100 shadow-2xl shadow-blue-500/10 backdrop-blur-xl sm:p-8">
        <button
          ...
          aria-label="Close member detail"
          onClick={onClose}
          className="absolute right-5 top-5 flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-xl leading-none text-slate-300 transition-all hover:border-red-500/30 hover:bg-red-500/20 hover:text-red-400"
        >
          x
        </button>
        ...
        <div className="pr-10">
          ...
          <div className="mt-2 flex items-center gap-2">
            <span className="rounded-md bg-blue-500/20 px-2.5 py-1 text-xs font-semibold text-blue-300 ring-1 ring-inset ring-blue-500/30">5027251019</span>
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 p-5 transition-all hover:bg-white/10 hover:shadow-md">
          ...
          <p className="mb-3 mt-2 text-sm font-semibold text-slate-200">C.H.R.I.S.Y.E.</p>
