...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto px-4 py-6">
      ...
      <div className="relative z-10 max-h-[calc(100dvh-48px)] w-full max-w-[760px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto rounded-[28px] border-4 border-slate-950 bg-[linear-gradient(180deg,#ef4444_0_92px,#111827_92px_104px,#f8fafc_104px_100%)] p-4 text-slate-950 shadow-[0_24px_70px_rgba(15,23,42,0.45)] sm:p-7">
        <button
          type="button"
          aria-label="Close member detail"
          onClick={handleClose}
