      ...
      <div className="relative z-10 h-[calc(100vh-9rem)] w-full max-w-[720px] animate-[member-popup-show_200ms_ease-out] overflow-hidden rounded-2xl border border-white/10 bg-black/25 shadow-[0_0_40px_rgba(255,255,255,0.08)] backdrop-blur-xl sm:h-[calc(100vh-10rem)]">
        ...
        <div className="relative z-10 h-full w-full overflow-y-auto p-6 sm:p-8">
          ...
          <button
            ...
            aria-label="Close member detail"
            onClick={onClose}
            className="absolute top-4 right-4 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-neutral-700 text-xl leading-none text-white hover:bg-neutral-700/20"
          >
            x
          </button>
          ...
          {/* Informasi Profil */}
          <div className="pr-10">
            <h2 className="text-2xl font-black tracking-wide text-neutral-100">Pradipta Airlangga Ramadhan</h2>
          ...
          <div className="mt-6 grid gap-4 text-sm font-semibold sm:grid-cols-2">
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-lg">
              <p className="text-xs font-bold tracking-wide text-[#d5b98a] uppercase">Hobi</p>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-lg backdrop-blur-md">
              <p className="text-xs font-bold tracking-wide text-[#d5b98a] uppercase">Fun Fact</p>
              <p className="mt-2 leading-relaxed text-neutral-200">
          ...
          {/* Spotify Container */}
          <div className="mt-4 mb-2 rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-lg backdrop-blur-md">
