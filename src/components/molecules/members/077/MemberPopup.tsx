...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden bg-[#05050e]/90 px-4 py-[5dvh] backdrop-blur-md">
      ...
      {/* WRAPPER KARTU UTAMA */}
      <div className="group animate-in fade-in zoom-in relative z-10 flex max-h-[90dvh] w-full max-w-[720px] flex-col duration-300">
