...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal((
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh] bg-[#0072BB]/60 backdrop-blur-md">
      ...
      {showIntro ? (
        ...
        <div className="relative z-10 w-full max-w-[720px] max-h-[90dvh] sm:max-h-[90dvh] overflow-y-auto rounded-[60px] border-[12px] border-black bg-[#FFE100] p-8 sm:p-10 text-black minion-shadow">
