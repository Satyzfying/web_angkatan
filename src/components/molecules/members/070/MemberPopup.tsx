...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh]">
      ...
      <div className="relative z-10 max-h-[90dvh] w-full max-w-[760px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto rounded-[1.75rem] border-2 border-cyan-300/80 bg-[#08111f] p-5 text-white shadow-[0_0_35px_rgba(34,211,238,0.22),0_24px_80px_rgba(0,0,0,0.55)] sm:max-h-[90dvh] sm:p-7">
