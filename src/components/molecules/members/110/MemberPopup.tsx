...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh]">
      ...
      <div
        className="jinx-hand relative z-10 max-h-[90dvh] w-full max-w-[720px] overflow-y-auto rounded-[20px] border-[3px] border-[#ff2e88] bg-[#150d36] p-6 text-white shadow-[0_0_45px_rgba(255,46,136,.4)] sm:p-8"
        style={{
