  ...
  return (
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto px-4 pt-28 pb-8 sm:pt-32">
      ...
      <div className="border-neutral-cs-10 bg-blue-cs-40 relative z-10 max-h-[calc(100vh-9rem)] w-full max-w-[720px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto rounded-2xl border-2 p-6 text-white shadow-xl sm:max-h-[calc(100vh-10rem)] sm:p-8">
        ...
        <div className="pr-10">
          {/* UBAH NAMA ANDA */}
          <h2 className="text-2xl font-black">Ronnin Raditya Putra Purbono</h2>
          {/* UBAH NRP DAN ASAL */}
        ...
        <div className="mt-6 grid gap-4 text-sm font-semibold sm:grid-cols-2">
          ...
          <div className="border-neutral-cs-10/40 rounded-xl border p-4">
            ...
            <p className="mt-2">Nama aku itu berasal dari bahasa Jepang. Kalau dicari di Google, artinya adalah prajurit atau samurai tanpa tuan.</p>
          </div>
        </div>
        ...
        <div className="border-neutral-cs-10/40 mt-4 rounded-xl border p-4">
          ...
          <p className="my-2 text-sm font-semibold">Malu Malu</p>

          {/* UBAH URL SPOTIFY KAMU DENGAN LAGU FAVORIT MU */}
          <SpotifyEmbed spotifyUrl="https://open.spotify.com/track/70mMQpJZwUuqardEybuaPP?si=fd5820ae936f45c6" />
        </div>
      </div>
    </div>
  )
