...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh] transition-all duration-300">
      <button
        type="button"
      ...
      */}
      <div className="relative z-10 max-h-[90dvh] w-full max-w-[640px] animate-[member-popup-show_300ms_cubic-bezier(0.34,1.56,0.64,1)] overflow-y-auto overscroll-contain rounded-2xl border-[3px] border-neutral-900 bg-[#FAF8F5] p-6 text-neutral-900 shadow-[12px_12px_0px_#000080] transition-all sm:p-8">
