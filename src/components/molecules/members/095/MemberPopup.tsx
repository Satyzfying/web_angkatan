...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto px-4 py-[5dvh]">
      ...
      <div className="relative z-10 max-h-[90dvh] w-full max-w-[720px] animate-[member-popup-show_200ms_ease_out] overflow-y-auto rounded-3xl border-2 border-cyan-300 bg-gradient-to-br from-blue-900 to-cyan-700 p-6 text-white shadow-2xl sm:p-8">
        <button
          type="button"
          aria-label="Close member detail"
          onClick={onClose}
