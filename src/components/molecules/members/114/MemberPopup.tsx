          ...
          <div id="suitButtons" className="flex justify-center gap-4 my-4">
            <button
              onClick={() => {
                ...
                (document.getElementById('gameLog') as HTMLElement)!.innerText = "Kamu: ✊ Batu -> AI: 🖐️ Kertas. (Kamu Kalah!)";
                if (count >= 3) { (document.getElementById('suitButtons') as HTMLElement)!.style.display = 'none'; (document.getElementById('cheatSection') as HTMLElement)!.style.display = 'block'; }
              }}
            ...
            <button
              onClick={() => {
                let count = parseInt((document.getElementById('skorKalah') as HTMLInputElement)!.value) + 1;
                (document.getElementById('skorKalah') as HTMLInputElement)!.value = count.toString();
                (document.getElementById('gameLog') as HTMLElement)!.innerText = "Kamu: 🖐️ Kertas -> AI: ✌️ Gunting. (Kamu Kalah!)";
                if (count >= 3) { (document.getElementById('suitButtons') as HTMLElement)!.style.display = 'none'; (document.getElementById('cheatSection') as HTMLElement)!.style.display = 'block'; }
              }}
              className="px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg border border-white/10"
            >🖐️ Kertas</button>
            <button
              onClick={() => {
                let count = parseInt((document.getElementById('skorKalah') as HTMLInputElement)!.value) + 1;
                (document.getElementById('skorKalah') as HTMLInputElement)!.value = count.toString();
                (document.getElementById('gameLog') as HTMLElement)!.innerText = "Kamu: ✌️ Gunting -> AI: ✊ Batu. (Kamu Kalah!)";
                if (count >= 3) { (document.getElementById('suitButtons') as HTMLElement)!.style.display = 'none'; (document.getElementById('cheatSection') as HTMLElement)!.style.display = 'block'; }
              }}
              className="px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg border border-white/10"
            >✌️ Gunting</button>
