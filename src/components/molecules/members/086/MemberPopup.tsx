...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="member-086-particle-stage fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh]">
      <button
        type="button"
      ...
      <div className="member-086-particle-card relative z-10 max-h-[90dvh] w-full max-w-[720px] overflow-y-auto rounded-2xl border border-white/[0.08] p-6 text-white shadow-2xl shadow-black/60 sm:max-h-[90dvh] sm:p-8">
        <button
          type="button"
          aria-label="Close member detail"
          onClick={onClose}
