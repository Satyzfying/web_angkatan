...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4 py-[5dvh]">
      ...
      />
      <div className="relative z-10 max-h-[90dvh] w-full max-w-[720px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto rounded-2xl border-2 border-green-200 bg-green-50 p-6 text-green-900 shadow-xl sm:max-h-[90dvh] sm:p-8">
        <button
          type="button"
          aria-label="Close member detail"
          onClick={onClose}
